...
import { idlFactory } from './multiagent_frontend.did.js';
export { idlFactory } from './multiagent_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_MULTIAGENT_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./multiagent_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the multiagent_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./multiagent_frontend.did.js")._SERVICE>}
 */
export const multiagent_frontend = createActor(canisterId);

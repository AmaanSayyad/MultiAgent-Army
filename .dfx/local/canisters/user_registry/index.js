...
import { idlFactory } from './user_registry.did.js';
export { idlFactory } from './user_registry.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_USER_REGISTRY;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./user_registry.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the user_registry canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./user_registry.did.js")._SERVICE>}
 */
export const user_registry = createActor(canisterId);

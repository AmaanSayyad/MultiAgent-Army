...
import { idlFactory } from './token_factory.did.js';
export { idlFactory } from './token_factory.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TOKEN_FACTORY;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./token_factory.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the token_factory canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./token_factory.did.js")._SERVICE>}
 */
export const token_factory = createActor(canisterId);

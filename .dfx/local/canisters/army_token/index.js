...
import { idlFactory } from './army_token.did.js';
export { idlFactory } from './army_token.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ARMY_TOKEN;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./army_token.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the army_token canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./army_token.did.js")._SERVICE>}
 */
export const army_token = createActor(canisterId);

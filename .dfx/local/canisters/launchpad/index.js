...
import { idlFactory } from './launchpad.did.js';
export { idlFactory } from './launchpad.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_LAUNCHPAD;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./launchpad.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the launchpad canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./launchpad.did.js")._SERVICE>}
 */
export const launchpad = createActor(canisterId);
